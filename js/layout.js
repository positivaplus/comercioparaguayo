...
window.onload = function () {
    //testimonial
    $("#testimonials").css({
        "background-image" : "url(./img/parallax/testimonial1.jpg)"
    });
    //team members
    $(".team-member").each((i,object)=>{
      var imgUrl = './' + $(object).find("img").attr("src").replace('rsz_','');
       $(object).find("img").attr('src', imgUrl);
    });
}
