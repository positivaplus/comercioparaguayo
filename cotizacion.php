...
$recaptcha = $_POST["g-recaptcha-response"];
	...
	if ($captcha_success->success) {
		// No eres un robot, continuamos con el env¨ªo del email
		// ...
		// ...
		$foto = $_FILES["foto"];
	...
	$mail->AddAddress("martin.cubilla@w3.com.py");
	...
	$mail->Subject = "CONSULTA  COTIZACIÓN - El Comercio Paraguayo Web";
	$fecha = date("d.m.Y, g:i a");
	$mensaje = "
			<span style='font-family:Verdana, Geneva, sans-serif'>
			<p><strong><span style='font-size:16px'>El Comercio Paraguayo Web - Solicitud de COTIZACIÓN </span></strong><br>
